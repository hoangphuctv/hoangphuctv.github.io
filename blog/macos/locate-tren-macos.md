...
<html>
	...
	<title>locate on mac - Tìm nhanh các tập tin bằng CLi trên macOS. | LẬP TRÌNH</title>
	...
	<p class="separator"></p>
		...
		<div class="container">
			<div class="markdown-body">
				<h1 class="page-title">locate on mac - Tìm nhanh các tập tin bằng CLi trên macOS.</h1>
								<p>---</p>
				Phuc Tran Hoang			</div>
			<div id="fb-root"></div>
<script async defer src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v3.2&appId=&autoLogAppEvents=1"></script>

<div class="fb-comment-embed" data-href="http://hoangphuctv.github.io./blog/macos/locate-tren-macos.md?/mdb" data-width="100%" data-include-parent="false"></div>
		</div>
		<br/>
		<div class="container">
			<hr>
	...
	<h6 class="border-bottom border-gray pb-2 mb-0">Các bài viết khác</h6>
		...
		<strong class="d-block text-gray-dark">
			<a href="/blog/macos/locate-tren-macos.md">locate on mac - Tìm nhanh các tập tin bằng CLi trên macOS.</a>
		</strong>
		<br>
