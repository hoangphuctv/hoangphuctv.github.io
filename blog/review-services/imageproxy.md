...
<html>
	...
	<title>Sử dụng imageproxy để tạo ảnh thumbnail thay thế timthumb.php | LẬP TRÌNH</title>
	...
	<p class="separator"></p>
		...
		<div class="container">
			<div class="markdown-body">
				<h1 class="page-title">Sử dụng imageproxy để tạo ảnh thumbnail thay thế timthumb.php</h1>
...
<div class="fb-comment-embed" data-href="http://hoangphuctv.github.io./blog/review-services/imageproxy.md?/mdb" data-width="100%" data-include-parent="false"></div>
		</div>
		<br/>
		<div class="container">
			<hr>
	...
	<h6 class="border-bottom border-gray pb-2 mb-0">Các bài viết khác</h6>
		...
		<strong class="d-block text-gray-dark">
			<a href="/blog/review-services/imageproxy.md">Sử dụng imageproxy để tạo ảnh thumbnail thay thế timthumb.php</a>
		</strong>
		<br>
